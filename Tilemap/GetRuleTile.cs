...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Gets the rule tile at the given XYZ coordinates of a cell in the tile map.")]

    public class GetRuleTile : FsmStateAction
    {
        ...
        void Action()
        {
            ...
            tile.Value = map.GetTile(positionInt);
        }
    }
}