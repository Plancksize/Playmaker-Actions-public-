...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sets a rule tile at the given XYZ coordinates of a cell in the tile map.")]

    public class SetRuleTile : FsmStateAction
    {
        ...
        void Action()
        {
            ...
            map.SetTile(positionInt, tile.Value as RuleTile);
        }
    }
}