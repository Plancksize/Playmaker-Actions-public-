...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Gets the color of a tile given the XYZ coordinates of a cell in the tile map.")]

    public class GetTileColor : FsmStateAction
    {
        ...
        void Action()
        {
            ...
            color.Value = map.GetColor(positionInt);
        }
    }
}