...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sets a Tile rotation")]

    public class SetTileRotation : FsmStateAction
    {
        ...
        [Tooltip("Sets a Rotation in degrees to the Tile")]
        [Title("Rotation")]
        ...
        public bool unlockTileFlags = false;
        ...
        void Action()
        {
            ...
            Matrix4x4 matrix = Matrix4x4.TRS(Vector3.zero, Quaternion.Euler(rotation.Value), Vector3.one);
