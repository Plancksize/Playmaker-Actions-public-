...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Gets a Tile rotation")]

    public class GetTileRotation : FsmStateAction
    {
        ...
        [Tooltip("Gets the Tile Rotation in degrees")]
        [Title("Rotation")]
        ...
        void Action()
        {
            ...
            rotation.Value = map.GetTransformMatrix(positionInt).rotation.eulerAngles;
        }
    }
}